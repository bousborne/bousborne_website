...
ttl="6001"                                  # Time to Live min value 600
port="1"                                    # Required port, Min value 1
weight="1"                                  # Required weight, Min value 1
key="your_godaddy_key"                      # key for godaddy developer API - prod
secret="your_godaddy_secret"       	        # secret for godaddy developer API - prod
